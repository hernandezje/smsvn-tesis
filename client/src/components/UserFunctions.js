...
export const register = async (Contacto) => {
  try {
    const response = await axios
      .post(
        "https:///smsvntesis.com:5000/users/register",
        { Contacto },
        {
          headers: {
...
export const login = async (user) => {
  ...
  try {
    const response = await axios
      .post(
        "https:///smsvntesis.com:5000/users/login", 
        JSON.stringify(user),
        { 
          headers: {
            "Content-Type": "application/json",
...
export const getAllContacts = async () => {
  try {
    ...
    const response = await fetch("https:///smsvntesis.com:5000/users/contactos", {
      method: "GET",
      headers: {
...
export const getNeonatoData = async () => {
  ...
  try {
    const response = await axios.get("https:///smsvntesis.com:5000/users/neonato", {
...
export const getAntecedentesData = async () => {
  ...
  try {
    const response = await axios.get("https:///smsvntesis.com:5000/users/antecedentes", {
      headers: { Authorization: token },
    });
    console.log("retorna:",response);
    return response.data;
...
export const createAntecedentes = async (newAntecedentes) => {
  ...
  try {
    const response = await axios
      .post("https:///smsvntesis.com:5000/users/newantecedentes", newAntecedentes, {
        headers: { Authorization: token },
      });
    console.log("LLEGA2:", response);
    return response.data;
...
export const getHistorial = async () => {
  try {
    ...
    // Realizar la solicitud al backend
    const response = await axios.get("https:///smsvntesis.com:5000/users/historial", {
      headers: {
        Authorization: token, // Enviar el token en los headers
      },
    });
...
export const getUserData = async () => {
  ...
  try {
    const response = await axios.get(`https:///smsvntesis.com:5000/users/usuario/${idUsuario}`, {
      headers: {
        "Content-Type": "application/json",
      },
    });
...
export const editUserData = async (idUsuario, updatedData) => {
  try {
    ...
    const response = await axios.put(
      `https:///smsvntesis.com:5000/users/editUsuario/${idUsuario}`,
...
export const deleteUserAccount = async (idUsuario, password) => {
  ...
  try {
    const response = await axios.post(
      `https:///smsvntesis.com:5000/users/delete/${idUsuario}`,
...
export const getAlertasFiltradas = async (fechaInicio, fechaFin) => {
  try {
    const response = await axios.get("https:///smsvntesis.com:5000/users/alertas", {
      params: {
        fechaInicio,
        fechaFin,
      },
...
export const updateNeonato = async (id, updatedData) => {
  try {
    ...
    const response = await axios.put(
      `https:///smsvntesis.com:5000/users/editNeonato/${id}`, // URL con el ID
...
export const updateAntecedenteMedico = async (id, updatedData) => {
  try {
    ...
    const response = await axios.put(
      `https:///smsvntesis.com:5000/users/editAntecedenteMedico/${id}`, // URL con el ID
      updatedData, // Datos enviados en el cuerpo de la solicitud
      {
        headers: {
          "Content-Type": "application/json", // Encabezado para JSON
...
export const generarReporte = async () => {
  ...
  try {
    const response = await axios.get("https:///smsvntesis.com:5000/users/generarReporte", {
      headers: { Authorization: token },
    });
...
export const getSensores = async () => {
  try {
    ...
    const response = await axios.get("https:///smsvntesis.com:5000/users/sensores", {
      headers: {
        Authorization: token,
      },
    });
...
export const getLatestSignosVitales = async () => {
  try {
    const response = await axios.get("https:///smsvntesis.com:5000/users/latest-signos-vitales");
...
export const getAlertas = async () => {
  try {
    ...
    const response = await axios.get("https:///smsvntesis.com:5000/users/latest-alertas", {
      headers: {
        Authorization: token,
      },
    });
...
const testConnection = async () => {
  try {
    const response = await axios.get('https:///smsvntesis.com:5000test/a'); // Ajusta la URL si es necesario
    if (response.data === 'OK') {
